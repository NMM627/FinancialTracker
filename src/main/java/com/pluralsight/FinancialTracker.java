    ...
    public static void main(String[] args) {
        ...
        public static void loadTransactions(String fileName){
            ...
            private static void addDeposit (Scanner scanner){
               ...
               // ask for description and get the information from the user

                // ask for vendor and get the information from the user

                // ask for amount and get the information from the user

                // add the new transaction too the arraylist

                // Use the bufferedwriter to write the new transaction the file use printf or String.format
            }
